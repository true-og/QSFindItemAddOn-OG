...
public final class QSFindItemAddOnOG extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (ENABLE_TRIAL_PERIOD) {
            ...
            LocalDateTime trialEndDate = LocalDate.of(TRIAL_END_YEAR, TRIAL_END_MONTH, TRIAL_END_DAY)
    ...
    private static class FindItemAdminCommandExecutor implements CommandExecutor, TabCompleter {
        ...
        public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
            ...
            if (!(sender.isOp() || sender.hasPermission(PlayerPermsEnum.FINDITEM_ADMIN.value())
            ...
            if (args[0].equalsIgnoreCase("reload")) {
                ...
                QSFindItemAddOnOG plugin = QSFindItemAddOnOG.getInstance() instanceof QSFindItemAddOnOG fia ? fia
                        : null;
                if (plugin != null) {
