...
public class UpdateChecker {
    ...
    private final String prefix = "&8[" + "&#55a800Q" + "&#5ea800S" + "&#66a800F" + "&#6ea900i" + "&#76a900n"
            + "&#7da900d" + "&#84a900I" + "&#8ba900t" + "&#92a900e" + "&#98a900m" + "&#9ea900A" + "&#a4a900d"
            + "&#aaa800d" + "&#b0a800O" + "&#b6a800n" + "&8] ";
    ...
    public void notifyPlayerAboutUpdateOnJoin(PlayerJoinEvent event) {
        ...
        if (player.isOp() || player.hasPermission(PlayerPerms.FINDITEM_ADMIN.value())) {
            ...
            if (FindItemAddOnOG.getPluginOutdated()) {

                player.sendMessage(ColorTranslator.translateColorCodes(prefix + "&#59b300Hey &#73e600"
                        + player.getName() + "&#59b300! Plugin has an update... You are still on v"
                        + FindItemAddOnOG.getInstance().getDescription().getVersion()));

                player.sendMessage(ColorTranslator.translateColorCodes(
                        prefix + "&#59b300Download here: &#a3a3c2&nhttps://www.spigotmc.org/resources/"
                                + FindItemAddOnOG.getPluginID() + "/"));
