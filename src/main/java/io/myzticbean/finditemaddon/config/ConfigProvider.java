...
public class ConfigProvider {
	...
	public final List<String> FIND_ITEM_COMMAND_ALIAS = (List<String>) ConfigSetup.get().getStringList(FIND_ITEM_COMMAND + "command-alias");
	...
	public final List<String> CUSTOM_CMDS_LIST = (List<String>) ConfigSetup.get().getStringList(PLAYER_SHOP_TELEPORTATION + CUSTOM_COMMANDS + "commands-list");
	...
	private final List<String> BLACKLISTED_WORLDS = (List<String>) ConfigSetup.get().getStringList("blacklisted-worlds");
	private final List<String> BLACKLISTED_MATERIALS = (List<String>) ConfigSetup.get().getStringList("blacklisted-materials");
